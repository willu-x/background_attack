...
round = startRound + 300
participant_population=1000
partipant_sample_size=10
isRandomNeurons = False
attack_round0=[i for i in range(startRound+5,startRound+105,20)]
attack_round1=[i for i in range(startRound+10,startRound+105,20)]
attack_round2=[i for i in range(startRound+15,startRound+105,20)]
attack_round3=[i for i in range(startRound+20,startRound+105,20)]
    ...
    if i in attack_round0:
        ...
        if i==attack_round0[0]:
            ...
            if isRandomNeurons:
                ...
                mask_grad_list=util.xzy_grad_mask_cv_by_layer(poison_model_with_hook,ratio=0.005)
        ...
        util.poison_train_trigger(poison_model,train_loaders[randInt:randInt+10], criterion=None, epoch=15 ,trigger=trigger0,isGray=True,locationX=25,locationY=25)
        ...
        util.poison_train_trigger(poison_model,train_loaders[randInt:randInt+10], criterion=None, epoch=15 ,trigger=trigger1,isGray=True,locationX=locationX_triger1,locationY=locationY_triger1)
        ...
        util.poison_train_trigger(poison_model,train_loaders[randInt:randInt+10], criterion=None, epoch=15 ,trigger=trigger2,isGray=True,locationX=locationX_triger2,locationY=locationY_triger2)
        ...
        util.poison_train_trigger(poison_model,train_loaders[randInt:randInt+10], criterion=None, epoch=15 ,trigger=trigger3,isGray=True,locationX=locationX_triger3,locationY=locationY_triger3)
